...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>The Retrofit Source Buyers Guide | Innovative Headlight Upgrades</title>
...
<body class="buyersGuide-landing" onLoad="MM_preloadImages('images/btn_bg-orangeDark.png','images/btn_bg-blueDark.png','images/btn_bg-grayDark.png')">



	<!-- Buyers Guide Landing
	================================================== -->
        ...
        <div class="container">
            <div class="full column">
                ...
                <div class="productGrid-products"> 
                    <h1><span class="title-upper">The Retrofitter's</span> Buyers Guide</h1>
                    <span class="sub-title"><h2>Finally, a simple tool to help you make the best purchasing decision based on your unique needs and situation</h2></span>
                    <span class="sub-title"><h3>Choose a category to get started</h3></span>
