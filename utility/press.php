...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>In The Press: All About The Retrofit Source | Innovative Headlight Upgrades</title>
	<meta name="description" content="People love to upgrade their vehicles, so it's obvious that The Retrofit Source would be featured in several auto magazines. Fifteen minutes of fame, immortalized in print.">
...
<body onLoad="MM_preloadImages('../images/btn_bg-orangeDark.png','../images/btn_bg-blueDark.png','../images/btn_bg-grayDark.png')">
    ...
    <div class="navMobile mobile-only"><?php require('../include/navMobile.html');?></div>
        ...
        <div class="container" id="inThePress">
        	...
        	<div class="bodyContainer">
                ...
                <div class="utility-contentContainer1">
                    <div class="allAboutTRS-header">            		
                        <h1>Immortalized in Print</h1>
                        <h3>Car magazine editors love free parts for their project cars. We love free advertising. They love our retrofits. Everybody wins!</h3>
                    </div>
                    		...
                    		<ul class="nonProductGrid">
                                ...
                                <a href="http://www.hondatuningmagazine.com/tech/0705_ht_hid_conversion/" target="_blank">
                                    ...
                                    <div class="nonProductGrid-info">
                                        ...
                                        <div class="nonProductGrid-specs">
                                            <span class="nonProductGrid-spec">Acura RL Bi-Xenon Retrofit</span>
                                        </div>
                                    </div>
                                </a>
                                </li>
                                ...
                                <a href="http://www.eurotuner.com/techarticles/160_0701_et_volkswagen_jetta_gli_hid_headlight_installation/" target="_blank">
                                    ...
                                    <div class="nonProductGrid-info">
                                        ...
                                        <div class="nonProductGrid-specs">
                                            <span class="nonProductGrid-spec">VW Jetta Bi-Xenon Retrofit</span>
                                        </div>
                                    </div>
                                </a>
                                </li>
                                ...
                                <a href="/client/trs/images/press/JapanesePerformance.pdf" target="_blank">
                                    ...
                                    <div class="nonProductGrid-info">
                                        ...
                                        <div class="nonProductGrid-specs">
                                            <span class="nonProductGrid-spec">Subaru Impreza Bi-Xenon Retrofit</span>
                                        </div>
                                    </div>
                                </a>
                                </li>
                                ...
                                <a href="http://www.nsnews.com/living/got-organs-1.363025" target="_blank">
                                    ...
                                    <div class="nonProductGrid-info">
                                        ...
                                        <div class="nonProductGrid-specs">
                                            <span class="nonProductGrid-spec">BMW E36 M3 Rally Retrofit</span>
                                        </div>
                                    </div>
                                </a>
                                </li>
                                ...
                                <a href="http://www.modified.com/tech/modp-1104-2008-subaru-impreza-wrx/" target="_blank">
                                    ...
                                    <div class="nonProductGrid-info">
                                        ...
                                        <div class="nonProductGrid-specs">
                                            <span class="nonProductGrid-spec">Subaru Impreza WRX Retro-Quick</span>
                                        </div>
                                    </div>
                                </a>
                                </li>
                                ...
                                <a href="http://www.truckinweb.com/toc/archive/1213tr_toc/" target="_blank">
                                    ...
                                    <div class="nonProductGrid-info">
                                        ...
                                        <div class="nonProductGrid-specs">
                                            <span class="nonProductGrid-spec">Ford Raptor Retrofit</span>
                                        </div>
                                    </div>
                                </a>
                                </li>
                                ...
                                <a href="/client/trs/images/press/PasMagAd.pdf" target="_blank">
                                    ...
                                    <div class="nonProductGrid-info">
                                        ...
                                        <div class="nonProductGrid-specs">
                                            <span class="nonProductGrid-spec">PAS-MAG Anniversary Edition Ad</span>
                                        </div>
                                    </div>
                                </a>
                                </li>
