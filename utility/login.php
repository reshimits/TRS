...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Login/Register to The Retrofit Source | Innovative Headlight Upgrades</title>
	<meta name="description" content="Login or Register as a new customer and take advantage of a faster and easier online shopping experience!">
...
<!-- =========== Body Content ================================================== -->
            ...
            <div class="bodyContainer utilityBodyContainer">
                <div class="utility-header"><h1>Login/Register</h1></div>
                
            	<div class="utility-sideColContainer2">
                	<div class="utility-intro">
                    	<h3>To continue, please create a new account or login with an existing username and password.<br><br> 
                        <span class="weightRegular-styleNormal">With an account, we'll save your contact and shipping information so that you can take advantage of a faster and easier online shopping experience.</span>
                        <br><br> 
                        <span class="weightRegular-styleNormal">Retrofitting is addicting, you'll see. <span class="weightRegular-styleItalic">Sign up today!</span></span></h3>
					</div>	
                </div>    
                ...
                <div class="utility-contentContainer2">
                        ...
                        <div class="utility-sectionContent">
                            ...
                            <form id="loginForm" action="/client/trs/utility/my-account.php" method="get">
                                ...
                                <div class="formCTAContainer">
                                	<div class="formCTA"><input class="formSubmit" type="submit" value="Login" /></div>
                            	</div>
                            </form>
                            </div>
                    ...
                    <div class="utility-section">            		
                        ...
                        <div class="utility-sectionContent">
                            ...
                            <form id="registrationForm" action="/client/trs/#.php" method="get">
                                ...
                                <div class="formCTAContainer">
                                	<div class="formCTA"><input class="formSubmit" type="submit" value="Register" /></div>
                            	</div>
                            </form>
                            </div>
                        </div>
                    ...
                    <div class="utility-section">            		
                        <h2><span class="weightRegular-styleNormal">Continue as Guest</span></h2>
                        <div class="utility-sectionContent">
                            <span class="utility-sectionSpecial">Save time now by providing us only the information we need to safely deliver your order.</span>
                        	<div class="generalBtn-orange"><a href="#"><span class="generalBtn-title">Checkout as Guest</span></a></div>
                        </div>
                    </div>
