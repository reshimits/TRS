...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Our Story: All About The Retrofit Source | Innovative Headlight Upgrades</title>
	<meta name="description" content="Take a peak inside headlight headquarters here in Atlanta, GA. Find out what it took to turn a basement business plan into the world's most recognized distributor for retrofitting parts.">
...
<body onLoad="MM_preloadImages('../images/btn_bg-orangeDark.png','../images/btn_bg-blueDark.png','../images/btn_bg-grayDark.png')">
    ...
    <div class="navMobile mobile-only"><?php require('../include/navMobile.html');?></div>
        ...
        <div class="container" id="allAboutTRS">
        	...
        	<div class="bodyContainer">
                ...
                <div class="utility-contentContainer1">
                    <div class="allAboutTRS-header">            		
                        <h1>How It Began. Who We Are.</h1>
                        <h3>With modest beginnings, an unwavering and arguably obsessive passion has resulted in TRS becoming the largest retrofit supplier in the world.</h3>
                    </div>
