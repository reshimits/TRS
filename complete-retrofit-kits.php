...
<body onLoad="MM_preloadImages('images/btn_bg-orangeDark.png','images/btn_bg-blueDark.png','images/btn_bg-grayDark.png')">
    ...
    <div class="navMobile mobile-only"><?php require('include/navMobile.html');?></div>
        ...
        <div class="productCategoryBanner">
            <?php require('buyersGuide/buyersGuide-completekits.html');?> 
        </div>
    ...
    <script type='text/javascript'>
        ...
        $( ".buyersGuide-filter .clearAll" ).click(function() {
            ...
            $(".buyersGuide-questionWrap").toggleClass( "toggle-q5",false );
            $(".buyersGuide-questionWrap").toggleClass( "toggle-q6",false );
        ...
        $( ".buyersGuide-select .select-a4" ).click(function() {
            $(".buyersGuide-questionWrap").toggleClass( "toggle-q5" );
        });
        $( ".buyersGuide-select .select-a5" ).click(function() {
            $(".buyersGuide-questionWrap").toggleClass( "toggle-q6" );
        });
        ...
        $( ".buyersGuide-selections .select-back2-a4" ).click(function() {
            $(".buyersGuide-questionWrap").toggleClass( "toggle-q5",false );
            $(".buyersGuide-questionWrap").toggleClass( "toggle-q6",false );
        });
        $( ".buyersGuide-selections .select-back2-a5" ).click(function() {
            $(".buyersGuide-questionWrap").toggleClass( "toggle-q6",false );
        });
    </script>
