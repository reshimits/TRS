...
<body onLoad="MM_preloadImages('../images/btn_bg-orangeDark.png','../images/btn_bg-blueDark.png','../images/btn_bg-grayDark.png','../images/btn_bg-redDark.png')">
    ...
    <div class="navMobile mobile-only"><?php require('../include/navMobile.html');?></div>
        ...
        <div class="container" id="diyDetail">
...
<!-- =========== Body Content ================================================== -->
                ...
                <div class="bodyContainer utilityBodyContainer">
                    ...
                    <div class="utility-header">
                        <h2>DIY Installation Guide</h2>
                        <h1>Morimoto H7 Motorcycle Harness (Single Output)</h1>
                    </div>
                    
                	<div class="utility-contentContainer">
                        <div class="productInfo-section">
                            <ul class="inTheBox">
                                <li>– Bi-xenon: FX-R 3.0</li><br>
                                <li>– Bi-xenon: Hella EvoX-R</li><br>
                                <li>– Bi-xenon: Acura TL / ZKW-R Lens</li><br>
                                <li>– Bi-xenon: Infiniti FX45</li><br>
                            </ul>
                            <ul class="inTheBox">
                                <li>– Bi-xenon: FX-R Stage III Kit</li><br>
                                <li>– Bi-xenon: FX-R Stage IV Kit</li><br>
                                <li>– Low Beam: Lexus RX-AFS / TSX-R Lens</li><br>
                                <li>– Low Beam: Acura TSX</li><br>
                            </ul>
                            <ul class="inTheBox">
                                <li>– Low Beam: Lexus RX-AFS Stage III Kit</li><br>
                                <li>– Low  Beam: Lexus RX-AFS Stage IV Kit</li><br>
                                <li>– VIP Projectors</li><br>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="diyWarningContainer">
                        <div class="productInfo-section diyInfo-section">
                            <span class="formNote"><span class="weightBold-styleItalic">Warning:</span> By reading this document, I agree that it is only intended to be used as an educational guide. The Retrofit Source, Inc. makes no guarantee on any finished results, nor are they to be held responsible for any damage, misuse, or personal injuries. Use at your own risk. If you are unable to clearly understand and adapt the information below to your own application, professional installation is available and recommended.</span>
                        </div>
                    </div>     
                </div>
                ...
                <div class="utility-tabNavContainer">
                    <ul class="tabNav">
                        <li class="tabNav-firstChild tabNav-active"><a href="#"><h1><span class="hide460">Step-by-step </span>Guide</h1></a></li>
                        <li class="tabNav-midChild"><a href="#vids">Instruction<span class="mobile-hide">al</span> Vid<span class="mobile-hide">eo</span>s</a></li>
                        <li class="tabNav-lastChild"><a href="#forum">Q&amp;A Forum</a></li>
                    </ul>
                </div>   
